<template>
  <div>
    ...
    >
      <el-option
        v-for="item in areas" :key="item.code" :value="item.code" :label="item.name"
      >
      </el-option>
    </el-select>
    <el-select 
    ...
    >
      <el-option
        v-for="item in selectCity" :key="item.code" :value="item.code" :label="item.name"
      >
      </el-option>
    </el-select>
    <el-select 
    ...
    >
      <el-option
        v-for="item in selectArea" :key="item.code" :value="item.code" :label="item.name"
      >
      </el-option>
    </el-select>
  </div>
